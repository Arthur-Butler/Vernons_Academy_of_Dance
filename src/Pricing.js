    ...
    return (
        <div className="pricing" id="pricing">
            ...
            <div className='pricingForeground'>
                <p className='bookingDescription'>Disclaimer: Due to the nature and size of my business, lesson prices will not be given on the website. I will reach out to you with prices once you have booked. If you have any questions please <a className="links" href="/booking">contact me</a>. The purpose of this page is simply to book lessons so I may booking you.</p>
                <hr className='aboutMeHR'/>
                <div className='lessonInfo'>
                    <div className="lessons" id="socialLessons">
                        <h2 className='lessonHead'>Social Lessons</h2>
                        <p>You will be taught amongst a welcoming and encouraging group of other couples. This experience provides a far more relaxed non-serious social environment. Recommended for couples who are not interested in competing and want a group experience.</p>
                        <button className='lessonBtn' onClick={()=>openForm("Social Lessons")}>BOOK NOW</button>
                    </div>
                    <div className="lessons" id="groupLessons">
                        <h2 className='lessonHead'>Group Lessons</h2>
                        <p>You will be practice alongside other couples. This experience is for couples that wish to train for competitions in a group environment. Recommended for competitive couples who wish to practice in a group setting.</p>
                        <button className='lessonBtn' onClick={()=>openForm("Group Lessons")}>BOOK NOW</button>
                    </div>
                    <div className="lessons" id="privateLessons">
                        <h2 className='lessonHead'>Private Lessons</h2>
                        <p>This is a one on one lesson format for couples who want a more private session. </p>
                ...
                <div className='bookingFormBG' >
                    <form ref={form} onSubmit={sendEmail} className='bookingForm'>
                        ...
                        <label className='bookingDiv'>
                            <div className='bookingLabel'>ENTER PARTNER FULL-NAME (NOT REQUIRED):</div>
                            <input type="text" name="from_partner_name" className='from_partner_name input'/>
                        </label>
                        <label className='bookingDiv'>
                        ...
                        <label className='bookingDiv'>
                            ...
                            <input type="text" name="lesson_type" className='lesson_type input' disabled/>
                        </label>
                        <center>
                        <ReCAPTCHA
                            ref={recaptchaRef}
